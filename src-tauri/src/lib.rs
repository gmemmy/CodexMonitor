...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            workspaces::get_active_selection_state,
            ...
            workspaces::set_active_workspace_selection,
            workspaces::set_active_thread_selection,
            workspaces::pin_workspace_thread,
            workspaces::unpin_workspace_thread,
            ...
            terminal::list_active_terminal_sessions,
